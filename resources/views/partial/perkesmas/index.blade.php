...
<body>
    <div class="container">
        ...
        <div class="l-right">
            ...
            <div class="ttable border bg-white mt-4">
                <div class="p-4">
                    <div class="input-group mb-3">
                        <form  action="/perkesmas/cari" method="GET">
                            <input type="text" class="form-control" placeholder="Search" name="cari" value="{{ old('cari') }}">
                            <button type="submit" class="btn btn-purple"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFFFFF" class="bi bi-search" viewBox="0 0 16 16">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="color-white color-neutral-400">
                            ...
                            <tr>
                                ...
                                <td class="col-1 td1">{{ $value->tanggal_kunjungan}}</td>
                                <td class="col-2 td1">{{ $value->nama_pasien}}</td>
                                <td class="col-2 td1">{{ $value->diagnosa_keperawatan}}</td>
                                <td class="col-2 td1">{{ $value->keterangan}}</td>
                                <td class="col-2">
                                    <a href="perkesmas/edit_perkesmas/{{ $value->id_perkesmas }}" class="btn">
                                    ...
                                    <a href="/perkesmas/show_perkesmas/{{ $value->id_perkesmas }}" class="btn">
                                    ...
                                    <button data-id="{{ $value->id_perkesmas}}" data-name="{{ $value->nama_pasien }}" type="submit" class="btn btn-simpanPerkesmas">
...
<script>
    $('.btn-simpanPerkesmas').click(function() {
        var id_perkesmas = $(this).attr('data-id');
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/perkesmas/hapusPerkesmas/" + id_perkesmas + "";
