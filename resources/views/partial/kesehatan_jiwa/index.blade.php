    ...
    <div class="container">
        ...
        <div class="l-right">
            ...
            <div class="ttable border-line bg-white mt-4">
                <div class="p-4">
                    <form class="input-group mb-3" action="/kesehatan_jiwa/cari" method="GET">
                    ...
                    <table class="table table-bordered rounded">
                        ...
                        @foreach($data as $key=>$value)
                            <tr>
                                ...
                                <td class="col-3">
                                    <a href="/kesehatan_jiwa/editKJiwa/{{ $value->id_kesehatan_jiwa}}" class="btn">
                                    ...
                                    <a href="/kesehatan_jiwa/detailKJiwa/{{ $value->id_kesehatan_jiwa}}" class="btn">
                                    ...
                                    <button data-id="{{ $value->id_kesehatan_jiwa}}" data-name="{{ $value->nama_pasien }}" type="submit" class="btn btn-hapusKesehatanJiwa">
...
<script>
    $('.btn-hapusKesehatanJiwa').click(function() {
        var id_kesehatan_jiwa = $(this).attr('data-id');
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/kesehatan_jiwa/hapusKJiwa/" + id_kesehatan_jiwa + "";
