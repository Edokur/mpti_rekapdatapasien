                ...
                <div class="p-4 mt-2">
                    ...
                    <table class="table table-bordered rounded">
                        ...
                        @foreach($data as $key=>$value)
                            <tr>
                                <td class="col-1 td1">{{ $value->id_kesehatan_jiwa }}</td>
                                ...
                                <td class="col-3">
                                <a href="/kesehatan_jiwa/edit/{{ $value->id_kesehatan_jiwa}}" class="btn">
                                    ...
                                    <a href="/kesehatan_jiwa/hapusKJiwa/{{ $value->id_kesehatan_jiwa}}" class="btn">
