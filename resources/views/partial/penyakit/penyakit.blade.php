            ...
            <div class="ttable border bg-white border-radius mt-4">
                <div class="p-4">
                    <div class="row px-3">
                        ...
                        <div class="col p-0">
                            <button class="tmbl btn-purple"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="35" fill="#FFFFFF" class="bi bi-search" viewBox="-3 -2 22 20">
