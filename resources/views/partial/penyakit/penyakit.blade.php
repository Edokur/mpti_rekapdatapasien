                        ...
                        @foreach($data as $key=>$value)
                            <tr>
                                ...
                                <td class="col-2 td1 border">
                                    ...
                                    <a href="/penyakit/detailPenyakit/{{ $value->id_register}}" class="btn">
                                    ...
                                    <button data-id="{{ $value->id_identitas_penyakit}}" data-name="{{ $value->nama_penyakit }}" type="submit" class="btn btn-simpanPenyakit">
...
<script>
    $('.btn-simpanPenyakit').click(function() {
