                ...
                <div class="p-4">
                    <table class="table table-bordered rounded">
                        <thead class="bg-grey color-white">
                            <tr>
                                <th class="col-1 head-tbl">No</th>
                                <th class="col-1 head-tbl">ID. Register</th>
                                <th class="col-1 head-tbl">Tanggal</th>
                                <th class="col-1 head-tbl">Minggu</th>
                                <th class="col-2 head-tbl">Nama Pasien</th>
                                <th class="col-3 head-tbl">Diagnosa</th>
                                <th class="col-2 head-tbl">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="color-white color-neutral-400">
                            <tr>
                                ...
                                <td class="col-1">01-01-2022</td>
                                <td class="col-1">1</td>
                                <td class="col-1">Putra Dino</td>
                                <td class="col-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque impedit quaerat, cum exercitationem repellendus corrupti molestias veritatis tempora rerum sit cupiditate vitae quibusdam quod dolor quas optio aliquam maxime iusto.</td>
                                <td class="col-2">
                                    <button class="tmbl">
                            ...
                            <tr>
                                ...
                                <td class="col-1">1</td>
                                <td class="col-1">Putra Dino</td>
                                <td class="col-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque impedit quaerat, cum exercitationem repellendus corrupti molestias veritatis tempora rerum sit cupiditate vitae quibusdam quod dolor quas optio aliquam maxime iusto.</td>
                                <td class="col-2">
                                    <button class="tmbl">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FF4C4C" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                                            <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
