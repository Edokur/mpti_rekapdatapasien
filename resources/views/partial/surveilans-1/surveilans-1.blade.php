                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="color-white color-neutral-400">
                            ...
                            <tr>
                                ...
                                <td class="col-1">{{ $value->id_pasien }}</td>
                                <td class="col-1">{{ $value->tanggal }}</td>
                                <td class="col-1">{{ $value->minggu }}</td>
                                <td class="col-1">{{ $value->nama_pasien }}</td>
                                <td class="col-4">{{ $value->diagnosa }}</td>
                                <td class="col-2">
                                    <a href="/surveilans-1/editSurveilans1/{{ $value->id}}" class="btn">
                                    ...
                                    <a href="/surveilans-1/showSurveilans1/{{ $value->id}}" class="btn">
                                    ...
                                    <a href="/surveilans-1/hapusSurveilans1/{{ $value->id}}" type="submit" class="btn">
