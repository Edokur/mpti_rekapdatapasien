...
<body>
    <div class="container">
        ...
        <div class="l-right">
            ...
            <div class="row mt-5">
                <div class="col">
                    <a href="/identitas_pasien/create">
                ...
                <a href="/identitas_pasien/export_excel" class="btn btn-outline-success px-5 py-3" target="_blank"><i class="fa-solid fa-print"></i> Cetak Data</a>
                </div>
            </div>

            <div class="col col-md-12 ttable border-line bg-white mt-4">
                <div class="p-4">
                    <form class="input-group mb-3" action="/identitas_pasien/cari" method="GET">
                        <input type="text" class="form-control" placeholder="Search" name="cari" value="{{ old('cari') }}">
                        <div class="input-group-append">
                            <a href="/identitas_pasien" class="btn btn-warning">
                    ...
                    <table class="table table-bordered">
                        ...
                        <thead class="bg-grey color-white">
                            <tr>
                                ...
                                <th class="col-1 th1">Jenis Kelamin</th>
                                <th class="col-2 th1">Alamat</th>
                                <th class="col-2 th1">Kepala Keluarga</th>
                        ...
                        <tbody class="color-white color-neutral-400">
                            ...
                            <tr>
                                ...
                                <td class="col-1 td1">{{ $value->jenis_kelamin}}</td>
                                <td class="col-2 td1">{{ $value->alamat}}</td>
                                <td class="col-2 td1">{{ $value->kepala_keluarga}}</td>
                                <td class="col-2 td1 border">
                                    <a href="/identitas_pasien/editIdentitas/{{ $value->id_register}}" class="btn">
                                    ...
                                    <a href="/identitas_pasien/detailIdentitas/{{ $value->id_register}}" class="btn">
                                    ...
                                    <button data-id="{{ $value->id_register}}" data-name="{{ $value->nama_pasien }}" type="submit" class="btn btn-simpanidentitas">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FF4C4C" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                                            <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z" />
                                        </svg>
                                    </button>
...
<script>
    $('.btn-simpanidentitas').click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/identitas_pasien/hapusIdentitas/" + id_surveilans1 + "";
