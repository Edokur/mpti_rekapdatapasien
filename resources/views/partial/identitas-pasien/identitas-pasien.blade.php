                    ...
                    <table class="table table-bordered rounded">
                        ...
                        <tbody class="color-white color-neutral-400">
                            ...
                            <tr>
                                ...
                                <th class="col-2">
                                    <a href="/identitas-pasien/editIdentitas/{{ $value->id}}" class="btn">
                                    ...
                                    <a href="/identitas-pasien/detailIdentitas/{{ $value->id}}" class="btn">
                                    ...
                                    <a href="/identitas-pasien/hapusIdentitas/{{ $value->id}}" class="btn">
