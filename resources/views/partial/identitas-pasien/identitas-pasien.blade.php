...
<body>
    <div class="container">
        ...
        <div class="l-right">
            ...
            <div class="row mt-5">
                <div class="col">
                    <a href="/identitas-pasien/create">
                    ...
                    <table class="table table-bordered rounded">
                        ...
                        <tbody class="color-white color-neutral-400">
                            ...
                            <tr>
                                ...
                                <th class="col-2">
                                    <a href="/identitas-pasien/editIdentitas/{{ $value->id_pasien}}" class="btn">
                                    ...
                                    <a href="/identitas-pasien/detailIdentitas/{{ $value->id_pasien}}" class="btn">
                                    ...
                                    <a href="/identitas-pasien/hapusIdentitas/{{ $value->id_pasien}}" class="btn">
