                        ...
                        <tr>
                            ...
                            <td class="col-1">
                                ...
                                <a href="/note/detailNote/{{ $value->id_note}}" class="btn">
                                    ...
                                    <button data-id="{{ $value->id_note}}" data-name="{{ $value->judul}}" type="submit" class="btn btn-hapusNote"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FF4C4C" class="bi bi-trash3-fill" viewBox="0 0 16 16">
