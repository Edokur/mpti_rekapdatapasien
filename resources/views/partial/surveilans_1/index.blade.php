                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="color-white color-neutral-400">
                            ...
                            <tr>
                                ...
                                <td class="col-2">
                                    <a href="/surveilans-1/editSurveilans1/{{ $value->pasien_id}}" class="btn">
                                    ...
                                    <a href="/surveilans-1/showSurveilans1/{{ $value->pasien_id}}" class="btn">
                                    ...
                                    <a href="/surveilans-1/hapusSurveilans1/{{ $value->pasien_id}}" type="submit" class="btn">
