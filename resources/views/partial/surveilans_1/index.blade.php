                        ...
                        <tbody class="color-white color-neutral-400">
                            ...
                            <tr>
                                ...
                                <td class="col-2">
                                    ...
                                    <a href="/surveilans_1/detailSurveilans1/{{ $value->pasien_id}}" class="btn">
                                    ...
                                    <a href="/surveilans_1/hapusSurveilans1/{{ $value->pasien_id}}" type="submit" class="btn">
